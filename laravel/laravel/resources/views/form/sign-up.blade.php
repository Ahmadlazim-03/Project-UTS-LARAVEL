      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Selamat Datang di Project Ujian Tengah Semester Workshop PWBF 2024</p>
          </div>
        </div>
      </div>
    </div>
              ...
              <form role="form text-left">
                ...
                <div class="form-check form-check-info text-left">
                  ...
                  <label class="form-check-label" for="flexCheckDefault">
                    Saya setuju <a href="javascript:;" class="text-dark font-weight-bolder"></a>
                  </label>
                </div>
                <div class="text-center">
                  <button type="button" id="registrasi" class="btn bg-gradient-dark w-100 my-4 mb-2">Register</button>
                </div>
